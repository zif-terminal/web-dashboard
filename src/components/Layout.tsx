...
const TABS: { k: Tab; label: string; short?: string }[] = [
  ...
  // #212-analytics: "Performance" relabelled to "Analytics" (key stays 'performance'
  // so persisted zif.tab isn't orphaned). Now the time-range hub that absorbs the
  // former standalone Income period breakdown.
  { k: 'performance', label: 'Analytics', short: 'Anly' },
