      ...
      addWallet: async (address, label): Promise<void> => {
        ...
        setTimeout(() => {
          ...
          this.wallets.unshift({
            ...
            accounts: [
              { id: id + 'm', walletId: id, name: label || 'Main account', exch: 'Lighter', type: 'main', value: 128450, pnl: 12300, accuracy: 'synced', dataComplete: true, needsApi: false, apiProvided: true, apiSkipped: false, hidden: false, tags: [] },
              { id: id + 'b', walletId: id, name: 'Binance', exch: 'Binance', type: 'main', value: 0, pnl: 0, accuracy: 'pending', dataComplete: true, needsApi: true, apiProvided: false, apiSkipped: false, hidden: false, tags: [] },
            ] as Account[],
          });
          this.pushAccounts();
        }, 2600);
